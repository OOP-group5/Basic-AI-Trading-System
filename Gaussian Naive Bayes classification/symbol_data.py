...
class SymbolData:
    ...
    def __init__(self, security, algorithm, num_days_per_sample=4, num_samples=100):
        """
        Input:
         - security: Security object for the security
         - algorithm: The algorithm instance running the backtest
         - num_days_per_sample: The number of open-close intraday returns for each sample
         - num_samples: The number of samples to train the model
        """
    ...
    def update_features(self, day, open_close_return):
        ...
        Inputs
         - day: Timestamp of when we're aware of the open_close_return
         - open_close_return: Open to close intraday return
    ...
    def CustomDailyHandler(self, sender, consolidated):
        ...
        Inputs
         ...
         - consolidated: Tradebar representing the latest completed trading day
        """
